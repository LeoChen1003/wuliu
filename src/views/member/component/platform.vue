<template>
  <div class="manage">
    <el-table :data="dataList" border :cell-style="cell">
      <el-table-column prop="createdAt" :label="$t('member.dateOfSubmission')">
      ...
      <div class="container">
        <el-form ref="form" label-width="150px">
          ...
          <el-form-item :label="$t('member.companyName')">
            <el-input class="inp" disabled v-model="infoForm.companyName" />
          </el-form-item>
          <el-form-item :label="$t('member.name')">
            <el-input class="inp" disabled v-model="infoForm.humanName" />
          </el-form-item>
          <el-form-item :label="$t('member.contacktName')">
            <el-input class="inp" disabled v-model="infoForm.contactName" />
          </el-form-item>
          <el-form-item :label="$t('member.phone_No')">
            <el-input class="inp" disabled v-model="infoForm.contactMobile" />
          </el-form-item>
          <el-form-item :label="$t('member.email')">
            <el-input class="inp" disabled v-model="infoForm.email" />
          </el-form-item>
          ...
          <el-form-item :label="$t('member.bankname')">
            <el-input class="inp" disabled v-model="infoForm.bank" />
          </el-form-item>
          <el-form-item :label="$t('member.accountName')">
            <el-input class="inp" disabled v-model="infoForm.bankAccountName" />
          </el-form-item>
          <el-form-item :label="$t('member.bankAccount_No')">
            <el-input class="inp" disabled v-model="infoForm.bankNumber" />
          </el-form-item>
